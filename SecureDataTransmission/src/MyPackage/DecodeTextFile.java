...
public class DecodeTextFile extends javax.swing.JFrame {

     File messageFile=null;
     String message=null;
   
    public DecodeTextFile() {
        initComponents();
        SetIcon();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Attach TextFile");
        ...
        jTextArea1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter Embedded Text/Attach File"));
        ...
        jDesktopPane3.setBorder(javax.swing.BorderFactory.createTitledBorder("Output"));

        jTextArea2.setColumns(20);
        jTextArea2.setRows(5);
        jTextArea2.setBorder(javax.swing.BorderFactory.createTitledBorder("DecodedText"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        messageFile = MyPackage.MessageHideSeek.getFile();
        message = MyPackage.MessageHideSeek.loadMessage(messageFile);
        jTextField1.setText(messageFile.getAbsolutePath());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String TextFile=jTextArea1.getText();
        try{
         String message = MyPackage.AESCrypt.decrypt(TextFile);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DecodeTextFile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DecodeTextFile().setVisible(true);
            }
        });
    }
