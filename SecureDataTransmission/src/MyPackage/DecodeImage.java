...
public class DecodeImage extends javax.swing.JFrame {
    ...
    public  int inspection(String text){
       int g=-1;
       while(g<0){
            ...
            if(password.length()>0)
            {
                ...
                while(i<=3)
                {
                   if(i==1)
                   {
                        ...
                        {
                             JOptionPane.showMessageDialog(null,"2 more chance \n Enter Valid KeyWords","Error",JOptionPane.WARNING_MESSAGE);
    ...
    private void initComponents() {
        ...
        jDesktopPane4.setBorder(javax.swing.BorderFactory.createTitledBorder("Image"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                ...
                imageFile = MessageHideSeek.getImage();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       try{
        message2 = AESCrypt.decrypt(message);
        }catch(Exception e)
        {
